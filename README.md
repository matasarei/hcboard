...
- **A toolbar that stays out of the way:** the gear (Developer mode and Settings), your password
  ...
  fold again when the keyboard hides; wide screens always show them. While you type a word, its
  suggestions take the left buttons' place; the chevron brings them back.
